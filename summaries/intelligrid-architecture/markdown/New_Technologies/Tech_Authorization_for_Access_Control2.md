...
> Source: https://xanthus-consulting.com/IntelliGrid_Architecture/New_Technologies/Tech_Authorization_for_Access_Control2.htm
...
within a security domain: **[Physical Assets](Tech_Authorization_for_Access_Control2.htm#Physical_Access_to_Assets);**
**[Computational Resources](Tech_Authorization_for_Access_Control2.htm#Computational_Resource);** and **[Information](Tech_Authorization_for_Access_Control2.htm#Informational_Technology_Assessment/Specification)**.
...
the use of multi-factor access control. It is further suggested that SMART-CARD[[2]](Tech_Authorization_for_Access_Control2.htm#_ftn2)s that double as personal identification
