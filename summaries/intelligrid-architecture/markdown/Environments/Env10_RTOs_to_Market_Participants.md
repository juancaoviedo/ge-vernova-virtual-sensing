...
> Source: https://xanthus-consulting.com/IntelliGrid_Architecture/Environments/Env10_RTOs_to_Market_Participants.htm
...
if !vml?![](Env10_RTOs_to_Market_Participants_files/image002.gif)endif?This
environment represents the communications requirements for control
centers to pass metering data to energy market participants.

**Typical Applications:**  Providing raw
data from utility, RTO or ISO control centers for use in energy
trading and marketing operations.

**Characteristics:** A business-to-business
environment in which volumes and speeds of data are not great, but the
data is critical to large sums of money being exchanged, and there may
be many users of the data.  Exchanges may take place over public
networks, so all types of attacks including denial-of-service are
therefore a possibility.

**Similar Environments:** Technologically
very similar to other business-to-business environments, but with the
strictest security requirements, and most likely to adopt modern
technology.
...
- [Non-repudiation](../New_Technologies/Tech_Non-repudiation.htm)
  - Security,
- [Path Routing and QOS Service](../New_Technologies/Tech_Path_Routing_and_QOS_Service.htm)
  - Security,
...
- [Quality of Identity Service](../New_Technologies/Tech_Quality_of_Identity_Service.htm)
  - Security,
- [Security against Denial-of-Service](../New_Technologies/Tech_Security_against_Denial-of-Service.htm)
  - Security,
...
- [RFC 1004 Distributed-protocol authentication scheme](../New_Technologies/Tech_RFC_1004_Distributed-protocol_authentication_scheme.htm)
  - Security,
- [RFC 1040 Privacy enhancement for Internet electronic mail: Part I: Message](../New_Technologies/Tech_RFC_1040_Privacy_enhancement_for_Internet_electronic_mail__P.htm) 
  - Security,
...
- [WC3 XML Key Management Specification (XKMS 2.0) Bindings](../New_Technologies/Tech_WC3_XML_Key_Management_Specification_(XKMS_2_0)_Bindings.htm)
  - Security,
- [W3C The Platform for Privacy Preferences 1.1 (P3P1.1) SpecificationW3C Working Draft 27 April 2004](../New_Technologies/Tech_W3C_The_Platform_for_Privacy_Preferences_1_1_(P3P1_1)_Specif.htm)
  - Security,
- [AGA-12 Cryptographic Protection of SCADA Communications General Recommendations.](../New_Technologies/Tech_AGA-12_Cryptographic_Protection_of_SCADA_Communications_Gene.htm)
  - Security,
