...
> Source: https://xanthus-consulting.com/IntelliGrid_Architecture/Environments/Env9_Control_Centers_to_ESPs.htm
...
if !vml?![](Env9_Control_Centers_to_ESPs_files/image002.gif)endif?

This environment encompasses the requirements
for communications between utility control centers and Energy Service
Providers (ESPs) or “aggregators”.

**Typical Applications:** Real-time pricing
negotiations, aggregated customer metering and settlements.  May
provide data later used for market operations.

**Characteristics:**  A business-to-business
environment, therefore having very strict requirements for security, a
contractual level of timeliness and record-keeping.  ESPs are a
volatile business environment, so the data may need to be reconfigured
on a monthly basis. Any metering data is usually aggregated and sent
in infrequent “batches”, so  it does not carry data at high volumes or
speeds.

**Similar Environments:** 
Technologically very similar to other
business-to-business environments, but connections and
