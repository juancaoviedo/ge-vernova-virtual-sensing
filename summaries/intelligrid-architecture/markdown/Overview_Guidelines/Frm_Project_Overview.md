...
> Source: https://xanthus-consulting.com/IntelliGrid_Architecture/Overview_Guidelines/Frm_Project_Overview.htm
...
![](../images/IECSA_Pyramid1.jpg)

The  ***IntelliGrid Project*** (previously known as the IECSA Project)
was sponsored by the
**Electric Power Research Institute** 
([EPRI](http://www.epri.com)). The project had two
objectives:

> 1) Theidentification of current and future ***Power System
> Functions*** thusdetermining the
> [Business
> Needs](../Use_Cases/IECSA_use_cases_overview.htm) of power system operations
...
> Architecture*** whichused these power system functional,
...
> toward a [Strategic Vision](Ovr_IECSA_Vision.htm),
> using a
> [Tactical Approach](../Technology_Analysis/Anl_Tach_Approach.htm) based on [IntelliGrid Environments](../Environments/Environments.htm) and technology
> independent techniques, based on
> [Standard Technologies and Best Practices](../New_Technologies/H1_Technology_List.htm).

In addition,
[Guidelines](Gud_Guidelines_Overview.htm) and
[Recommendations](Rec_Recommendations.htm) are
focused on the different users of the IntelliGrid
Architecture so that they can understand the concepts presented by the
IntelliGrid Architecture, and can use it effectively to pursue their
respective goals.
...
Project was
managed by [General Electric](http://www.ge.com),
with major contributions from
[Utility Consulting
International (UCI)](http://www.uci-usa.com), [SISCO](http://www.sisconet.com), [Lucent](http://www.bell-labs.com),
[EnerNex](http://www.enernex.com), **Hypertek**,
and many [Stakeholders](Adl_Stakeholders.htm). As
seen in the figure, the process involved two types of
experts: the power system function experts and the
architecture experts:

1.     
**[Power System Function Experts](../Use_Cases/IECSA_use_cases_overview.htm)**. Described existing and
...
2.     
**[IntelliGrid Architecture
Experts](../High_Level_Concepts/HLC_IECSA_Framework.htm)**. Developed the IntelliGrid Architecture based on the
